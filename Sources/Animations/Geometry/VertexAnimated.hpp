...
namespace acid
{
	...
	{
	public:
		VertexAnimated(const Vector3 &position = Vector3::Zero, const Vector2f &uv = Vector2f(), const Vector3 &normal = Vector3::Zero, const Vector3 &tangent = Vector3::Zero, const Vector3 &jointId = Vector3::Zero, const Vector3 &vertexWeight = Vector3::Zero);
