...
namespace acid
{
	...
	UiStartLogo::UiStartLogo(UiObject *parent) :
		...
		m_guiBackground(std::make_unique<Gui>(this, UiBound(Vector2f(0.5f, 0.5f), UiReference::Centre, UiAspect::Position, Vector2f(1.0f, 1.0f)), Texture::Create("Guis/Black.png"))),
		m_guiLogoAcid(std::make_unique<Gui>(this, UiBound(Vector2f(0.5f, 0.5f), UiReference::Centre, UiAspect::Position | UiAspect::Dimensions, Vector2f(0.4f, 0.4f)), Texture::Create("Logos/Acid_01.png"))),
		m_textCopyright(std::make_unique<Text>(this, UiBound(Vector2f(0.5f, 0.8f), UiReference::Centre, UiAspect::Position | UiAspect::Dimensions), 1.8f, "Copyright (C) 2019, Equilibrium Games - All Rights Reserved.",
